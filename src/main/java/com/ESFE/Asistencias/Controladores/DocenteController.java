...
public class DocenteController {
    @Autowired
    private IGDocenteServices docenteServices;
    @GetMapping
    ...
    @PostMapping("/save")
    public String save(Docente docente, BindingResult result, Model model, RedirectAttributes atrributes){
        if(result.hasErrors()){
        ...
        atrributes.addFlashAttribute("msg", "Docente creado correctamente");
