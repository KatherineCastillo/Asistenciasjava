...
import com.ESFE.Asistencias.Repositorio.IGDocenteRepository;
...
@Service
public class  DocenteServices implements IGDocenteServices {
    @Autowired
    private IGDocenteRepository docenteRepository;
    @Override
